...
void __cdecl DumpErrList3ds(FILE *outfile);
void __cdecl ClearErrList3ds();
const ErrRec3ds * __cdecl ReturnErrorList3ds();


/* Functions to use with namelist3ds structures */
void __cdecl InitNameList3ds(namelist3ds **chunk, ulong3ds count);
void __cdecl ReleaseNameList3ds(namelist3ds **chunk);
void __cdecl AddToNameList3ds(namelist3ds **list, char3ds *name);

/* File control functions */
file3ds * __cdecl OpenFile3ds(const char3ds *filename, const char *attrib);
void __cdecl CloseAllFiles3ds();
void __cdecl CloseFile3ds(file3ds *file);


/* Database functions */
void __cdecl InitDatabase3ds(database3ds **db);
void __cdecl ReleaseDatabase3ds(database3ds **db);
void __cdecl CreateDatabase3ds(file3ds *file, database3ds *db);
void __cdecl CreateNewDatabase3ds(database3ds *db, dbtype3ds type);
dbtype3ds __cdecl GetDatabaseType3ds(database3ds *db);
void __cdecl CopyDatabase3ds(database3ds *idb, database3ds *odb);
void __cdecl DisconnectDatabase3ds(database3ds *db);
void __cdecl WriteDatabase3ds(file3ds *file, database3ds *db);
void __cdecl InitViewport3ds(viewport3ds **vp);
void __cdecl ReleaseViewport3ds(viewport3ds **vp);
void __cdecl GetViewport3ds(database3ds *db, viewport3ds **vp);
void __cdecl PutViewport3ds(database3ds *db, viewport3ds *vp);
void __cdecl CopyViewport3ds(database3ds *destdb, database3ds *srcdb);
void __cdecl InitMeshSet3ds(meshset3ds **);
void __cdecl ReleaseMeshSet3ds(meshset3ds **);
void __cdecl GetMeshSet3ds(database3ds *, meshset3ds **);
void __cdecl PutMeshSet3ds(database3ds *db, meshset3ds *settings);
void __cdecl CopyMeshSet3ds(database3ds *destdb, database3ds *srcdb);

void __cdecl InitAtmosphere3ds(atmosphere3ds **atmo);
void __cdecl ReleaseAtmosphere3ds(atmosphere3ds **atmo);
void __cdecl GetAtmosphere3ds(database3ds *db, atmosphere3ds **atmo);
void __cdecl PutAtmosphere3ds(database3ds *db, atmosphere3ds *atmo);
void __cdecl CopyAtmosphere3ds(database3ds *destdb, database3ds *srcdb);

void __cdecl InitBackground3ds(background3ds **bgnd);
void __cdecl ReleaseBackground3ds(background3ds **bgnd);
void __cdecl GetBackground3ds(database3ds *db, background3ds **bgnd);
void __cdecl PutBackground3ds(database3ds *db, background3ds *bgnd);
void __cdecl CopyBackground3ds(database3ds *destdb, database3ds *srcdb);

short3ds __cdecl AddMaterial3ds(const material3ds *mat);
void __cdecl InitBitmap3ds(bitmap3ds *map);
short3ds __cdecl InitMaterial3ds(material3ds **mat);
void __cdecl ReleaseMaterial3ds(material3ds **mat);
ulong3ds __cdecl GetMaterialCount3ds(database3ds *db);
void __cdecl GetMaterialNameList3ds(database3ds *db, namelist3ds **list);
void __cdecl GetMaterialByIndex3ds(database3ds *db, ulong3ds index, material3ds **mat);
void __cdecl GetMaterialByName3ds(database3ds *db, char3ds *name, material3ds **mat);
void __cdecl PutMaterial3ds(database3ds *db, material3ds *mat);
void __cdecl CopyMaterialByName3ds(database3ds *destdb, database3ds *srcdb, char3ds *name);
void __cdecl CopyMaterialByIndex3ds(database3ds *destdb, database3ds *srcdb, ulong3ds index);
void __cdecl DeleteMaterialByName3ds(database3ds *db, char3ds *name);
void __cdecl DeleteMaterialByIndex3ds(database3ds *db, ulong3ds index);
void __cdecl InitMeshObj3ds(mesh3ds **obj, ushort3ds nvertices, ushort3ds nfaces, ushort3ds iniflags);
void __cdecl InitMeshObjField3ds(mesh3ds *obj, ushort3ds const initflags);
void __cdecl InitMatArrayIndex3ds (mesh3ds *obj, ushort3ds mat, ushort3ds nfaces);

/* Mesh object functions */
ulong3ds __cdecl GetMeshCount3ds(database3ds *db);
void __cdecl GetMeshNameList3ds(database3ds *db, namelist3ds **list);
void __cdecl GetMeshByIndex3ds(database3ds *db, ulong3ds index, mesh3ds **mesh);
void __cdecl GetMeshByName3ds(database3ds *db, char3ds *name, mesh3ds **mesh);
void __cdecl PutMesh3ds(database3ds *db, mesh3ds *mesh);
void __cdecl CopyMeshByName3ds(database3ds *destdb, database3ds *srcdb, char3ds *name);
void __cdecl CopyMeshByIndex3ds(database3ds *destdb, database3ds *srcdb, ulong3ds index);
void __cdecl DeleteMeshByName3ds(database3ds *db, char3ds *name);
void __cdecl DeleteMeshByIndex3ds(database3ds *db, ulong3ds index);
void __cdecl RelMeshObj3ds(mesh3ds **obj);

/* Light related functions */
void __cdecl InitLight3ds(light3ds **light);
void __cdecl InitSpotlight3ds(light3ds **spotlight);
void __cdecl ReleaseLight3ds(light3ds **light);
ulong3ds __cdecl GetOmnilightCount3ds(database3ds *db);
ulong3ds __cdecl GetSpotlightCount3ds(database3ds *db);
void __cdecl GetOmnilightNameList3ds(database3ds *db, namelist3ds **list);
void __cdecl GetSpotlightNameList3ds(database3ds *db, namelist3ds **list);
void __cdecl GetSpotlightByIndex3ds(database3ds *db, long3ds index, light3ds **light);
void __cdecl GetOmnilightByIndex3ds(database3ds *db, long3ds index, light3ds **light);
void __cdecl GetSpotlightByName3ds(database3ds *db, char3ds *name, light3ds **light);
void __cdecl GetOmnilightByName3ds(database3ds *db, char3ds *name, light3ds **light);
void __cdecl PutSpotlight3ds(database3ds *db, light3ds *light);
void __cdecl PutOmnilight3ds(database3ds *db, light3ds *light);
void __cdecl CopySpotlightByName3ds(database3ds *destdb, database3ds *srcdb, char3ds *name);
void __cdecl CopySpotlightByIndex3ds(database3ds *destdb, database3ds *srcdb, ulong3ds index);
void __cdecl CopyOmnilightByName3ds(database3ds *destdb, database3ds *srcdb, char3ds *name);
void __cdecl CopyOmnilightByIndex3ds(database3ds *destdb, database3ds *srcdb, ulong3ds index);
void __cdecl DeleteSpotlightByIndex3ds(database3ds *db, ulong3ds index);
void __cdecl DeleteOmnilightByIndex3ds(database3ds *db, ulong3ds index);
void __cdecl DeleteSpotlightByName3ds(database3ds *db, char3ds *name);
void __cdecl DeleteOmnilightByName3ds(database3ds *db, char3ds *name);
void __cdecl InitCamera3ds(camera3ds **cam);
void __cdecl ReleaseCamera3ds(camera3ds **cam);
ulong3ds __cdecl GetCameraCount3ds(database3ds *db);
void __cdecl GetCameraNameList3ds(database3ds *db, namelist3ds **list);
void __cdecl GetCameraByIndex3ds(database3ds *db, ulong3ds index, camera3ds **cam);
void __cdecl GetCameraByName3ds(database3ds *db, char3ds *name, camera3ds **cam);
void __cdecl PutCamera3ds(database3ds *db, camera3ds *cam);

void __cdecl CopyCameraByName3ds(database3ds *destdb, database3ds *srcdb, char3ds *name);
void __cdecl CopyCameraByIndex3ds(database3ds *destdb, database3ds *srcdb, ulong3ds index);

void __cdecl DeleteCameraByName3ds(database3ds *db, char3ds *name);
void __cdecl DeleteCameraByIndex3ds(database3ds *db, ulong3ds index);

void __cdecl InitKfSets3ds(kfsets3ds **key);
void __cdecl ReleaseKfSets3ds(kfsets3ds **key);
void __cdecl PutKfSets3ds(database3ds *db, kfsets3ds *key);
void __cdecl GetKfSets3ds(database3ds *db, kfsets3ds **key);
void __cdecl CopyKfSets3ds(database3ds *destdb, database3ds *srcdb);


void __cdecl InitCameraMotion3ds(kfcamera3ds **cam, ulong3ds npkeys, ulong3ds nfkeys,
                             ulong3ds nrkeys, ulong3ds ntkeys);

void __cdecl GetCameraMotionByName3ds(database3ds *db, 
			      char3ds *name, 
			      kfcamera3ds **kfcam);

void __cdecl GetCameraMotionByIndex3ds(database3ds *db, 
			       ulong3ds index,
			       kfcamera3ds **kfcam);

void __cdecl PutCameraMotion3ds(database3ds *db, kfcamera3ds *kfcam);


void __cdecl ReleaseCameraMotion3ds(kfcamera3ds **cam);

ulong3ds __cdecl GetCameraNodeCount3ds(database3ds *db);

void __cdecl GetCameraNodeNameList3ds(database3ds *db, namelist3ds **list);

void __cdecl DeleteCameraMotionByIndex3ds(database3ds *db, ulong3ds index);
void __cdecl DeleteCameraMotionByName3ds(database3ds *db, char3ds *name);
void __cdecl CopyCameraMotionByIndex3ds(database3ds *destdb, database3ds *srcdb, ulong3ds index);
void __cdecl CopyCameraMotionByName3ds(database3ds *destdb, database3ds *srcdb, char3ds *name);


/* Ambient Light Animation Functions */
void __cdecl InitAmbientLightMotion3ds(kfambient3ds **light, ulong3ds nckeys);
void __cdecl ReleaseAmbientLightMotion3ds(kfambient3ds **light);
void __cdecl GetAmbientLightMotion3ds(database3ds *db, kfambient3ds **kfambient);
void __cdecl PutAmbientLightMotion3ds(database3ds *db, kfambient3ds *kfambient);
void __cdecl DeleteAmbientLightMotion3ds(database3ds *db);
void __cdecl CopyAmbientLightMotion3ds(database3ds *destdb, database3ds *srcdb);
void __cdecl InitObjectMotion3ds(kfmesh3ds **obj, 
			 ulong3ds npkeys, 
			 ulong3ds nrkeys, 
			 ulong3ds nskeys, 
			 ulong3ds nmkeys,
...
void __cdecl ReleaseObjectMotion3ds(kfmesh3ds **obj);

void __cdecl GetObjectNodeNameList3ds(database3ds *db, 
			      namelist3ds **list);

ulong3ds __cdecl GetObjectNodeCount3ds(database3ds *db);

void __cdecl GetObjectMotionByName3ds(database3ds *db, 
			      char3ds *name, 
			      kfmesh3ds **kfmesh);

void __cdecl GetObjectMotionByIndex3ds(database3ds *db, 
			       ulong3ds index,
			       kfmesh3ds **kfmesh);

void __cdecl PutObjectMotion3ds(database3ds *db,
			kfmesh3ds *kfmesh);

void __cdecl DeleteObjectMotionByIndex3ds(database3ds *db, ulong3ds index);
void __cdecl DeleteObjectMotionByName3ds(database3ds *db, char3ds *name);
void __cdecl CopyObjectMotionByIndex3ds(database3ds *destdb, database3ds *srcdb, ulong3ds index);
void __cdecl CopyObjectMotionByName3ds(database3ds *destdb, database3ds *srcdb, char3ds *name);
void __cdecl InitOmnilightMotion3ds(kfomni3ds **light, 
			    ulong3ds npkeys, 
			    ulong3ds nckeys);

void __cdecl ReleaseOmnilightMotion3ds(kfomni3ds **light);

void __cdecl GetOmnilightNodeNameList3ds(database3ds *db, 
				 namelist3ds **list);

void __cdecl GetOmnilightMotionByName3ds(database3ds *db, 
				 char3ds *name, 
				 kfomni3ds **kfomni);

void __cdecl GetOmnilightMotionByIndex3ds(database3ds *db, 
				  ulong3ds index,
				  kfomni3ds **kfomni);

ulong3ds __cdecl GetOmnilightNodeCount3ds(database3ds *db);

void __cdecl PutOmnilightMotion3ds(database3ds *db, 
			   kfomni3ds *kfomni);

void __cdecl PutOmnilightMotion3ds(database3ds *db, 
			   kfomni3ds *kfomni);

void __cdecl DeleteOmnilightMotionByIndex3ds(database3ds *db, ulong3ds index);
void __cdecl DeleteOmnilightMotionByName3ds(database3ds *db, char3ds *name);
void __cdecl CopyOmnilightMotionByIndex3ds(database3ds *destdb, database3ds *srcdb, ulong3ds index);
void __cdecl CopyOmnilightMotionByName3ds(database3ds *destdb, database3ds *srcdb, char3ds *name);
void __cdecl InitSpotlightMotion3ds(kfspot3ds **spot, 
                ulong3ds npkeys, 
                ulong3ds nckeys, 
                ulong3ds nhkeys, 
                ulong3ds nfkeys, 
...
void __cdecl ReleaseSpotlightMotion3ds(kfspot3ds **spot);

void __cdecl GetSpotlightNodeNameList3ds(database3ds *db, 
				 namelist3ds **list);

ulong3ds __cdecl GetSpotlightNodeCount3ds(database3ds *db);

void __cdecl GetSpotlightMotionByName3ds(database3ds *db, 
                 char3ds *name, 
                 kfspot3ds **kfspot);

void __cdecl PutSpotlightMotion3ds(database3ds *db, 
			   kfspot3ds *kfspot);

void __cdecl GetSpotlightMotionByIndex3ds(database3ds *db, 
		  ulong3ds index,
		  kfspot3ds **kfspot);

void __cdecl DeleteSpotlightMotionByIndex3ds(database3ds *db, ulong3ds index);
void __cdecl DeleteSpotlightMotionByName3ds(database3ds *db, char3ds *name);
void __cdecl CopySpotlightMotionByIndex3ds(database3ds *destdb, database3ds *srcdb, ulong3ds index);
void __cdecl CopySpotlightMotionByName3ds(database3ds *destdb, database3ds *srcdb, char3ds *name);

void __cdecl FillMatrix3ds(mesh3ds *obj);
void __cdecl SetBoundBox3ds(const mesh3ds *mobj, kfmesh3ds *kobj );
void __cdecl DumpMapInfo3ds(FILE *out, mapinfo3ds *map, long3ds dumplevel);
void __cdecl DumpMesh3ds(FILE *out, mesh3ds *mesh, long3ds dumplevel);
void __cdecl DumpMaterial3ds(FILE *out, material3ds *mat, long3ds dumplevel);
void __cdecl DumpBitmap3ds(FILE *out, bitmap3ds *map, long3ds dumplevel);
void __cdecl SetDumpLevel3ds(long3ds newlevel);
void __cdecl DumpDatabase3ds(FILE *outfile, database3ds *db);
