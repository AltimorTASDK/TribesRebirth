...
@@vectorLoop:
   ...
   fld   DWORD PTR [edi + eax * 4]           ; ST = v_j, , weight
   fld   DWORD PTR [esi + eax * 4]           ; ST = cm_j, v_j, weight
   fsub                                      ; ST = (v_j - cm_j), weight

   fmul                                      ; ST = ((v_j - cm_j) * weight)
   fld   DWORD PTR [edi + ebx * 4]           ; ST = v_i, ((v_j - cm_j) * weight)
   fld   DWORD PTR [esi + ebx * 4]           ; ST = cm_i, v_i, ((v_j - cm_j) * weight)
